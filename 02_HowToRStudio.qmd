...
If you want to have it locally, install it from \[https://posit.co/products/open-source/rstudio/?sid=1\](https://posit.co/products/open-source/rstudio/?sid=1). It will tell you to download and install the bare R first, from \[https://cran.r-project.org/\](https://cran.r-project.org/).
:::
...
::: notes
In the top Menu, Select File \> New. You will get a choice from a number of formats. I write this with the Quarto tool and choose Quarto presentation. Another option is Quarto document. It is no big deal what you choose. Both are plain text files.
:::
