...
![Your server is not running. Just (re)start it. This can also happen to you when you are idle for a long time. When you refresh your non-responding page, you will see this.](images_ATRIUM/Jupyterlab_07_ServerNotRunnin.png){#fig-jupyter_server_notrunning}
