...
-   Web ⤇ Your PC ⤇ Jupyterlab RStudio
...
## Your RStudio ≈ Your Home Directory {.smaller}
...
I store all my teaching materials in a GitHub **repository** for backup and access from different computers. You can download everything from there without bothering about the Git commands. If I change something later, it will not update in your copy.
:::
...
`https://download-directory.github.io/?url=https://github.com/`*THE_NAME_OF_THE_REPO*`/tree/main/`*THE_NAME_OF_THE_FOLDER*
...
::: {.column width="50%"}
![Path to your home as `/lnet/aic/personal/YOU`](images_ATRIUM/RStudio_08_PathOverLNET_AIC_PERSONAL.png){#RStudio_08_PathOverLNET_AIC_PERSONAL}
:::
:::
...
-   It's only the file that travels!
...
## Copy someone's [**folder**]{.underline} to your home {.smaller}
