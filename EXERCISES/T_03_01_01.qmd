...
billionaires_Persons <- read_csv(file = "https://raw.githubusercontent.com/open-numbers/ddf--gapminder--billionaires/refs/heads/master/ddf--entities--person.csv", show_col_types = FALSE)
...
write_tsv(x = billionaires_df, file = "datasets_ATRIUM/billionaires_combined.tsv")
```
...
```{r dataset-01}
#| echo: false
billionaires_df <- read_tsv(file = "datasets_ATRIUM/billionaires_combined.tsv", show_col_types = FALSE)
```
